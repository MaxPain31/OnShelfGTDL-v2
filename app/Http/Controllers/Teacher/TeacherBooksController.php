...
class TeacherBooksController extends BaseTeacherController
{
                ...
                if ($adminRole) {
                    ...
                    foreach ($admins as $admin) {
                        Notification::create([
                            ...
                            'message' => "{$userName} (Teacher) has borrowed \"{$book->book_name}\". Due date: {$dueDate->format('M d, Y')}.",
                            'related_id' => $borrow->id,
                            'related_type' => BookBorrow::class,
                            'data' => [
                                'book_name' => $book->book_name,
                ...
                if ($adminRole) {
                    ...
                    foreach ($admins as $admin) {
                        Notification::create([
                            ...
                            'message' => "{$userName} (Teacher) has reserved \"{$book->book_name}\". Claim deadline: {$claimDeadline->format('M d, Y')}.",
                            'related_id' => $reservation->id,
                            'related_type' => BookReservation::class,
                            'data' => [
                                'book_name' => $book->book_name,
