...
class TeacherEbooksController extends BaseTeacherController
{
    ...
    public function read(Ebook $ebook): View|RedirectResponse
    {
        ...
        if (!$ebook->ebook_file_path) {
            return redirect()->route('teacher.ebooks')->with('error', 'E-book file is not available.');
        }
        ...
        return view('teacher.ebook-reader', [
            'ebook' => $ebook,
