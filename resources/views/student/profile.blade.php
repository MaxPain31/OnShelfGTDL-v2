    ...
    >
        ...
        <div class="rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    <p class="text-sm font-semibold text-[#7c4c63] mb-1">LRN</p>
                    <p class="text-base text-[#4b2036]">{{ $user->userInfo->lrn ?? '—' }}</p>
                </div>
                <div>
                ...
                <div>
                    <p class="text-sm font-semibold text-[#7c4c63] mb-1">Grade</p>
                    <p class="text-base text-[#4b2036]">{{ $user->userInfo->grade }}</p>
                </div>
                @endif
                @if($user->userInfo && $user->userInfo->section)
                <div>
                    <p class="text-sm font-semibold text-[#7c4c63] mb-1">Section</p>
                    <p class="text-base text-[#4b2036]">{{ $user->userInfo->section }}</p>
                </div>
                @endif
            </div>
        </div>
