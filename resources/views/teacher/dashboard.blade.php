...
@section('title', 'Teacher Dashboard | OnShelf GTDL')
...
@section('content')
    <div
        ...
        x-init="
            ...
            if (typeof Chart !== 'undefined') {
                ...
                // Student Registration Chart (from manage students data)
    ...
    >
        ...
        <section class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('teacher.borrowed-books') }}" class="rounded-full border border-[#f3cbe0] px-4 py-2 text-sm text-[#a03464] hover:bg-[#fff2f8] transition">
                        View All
                    </a>
                </div>
                <div class="h-64">
            ...
            <div class="rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
                ...
                <div class="mt-6 space-y-3">
                    ...
                    <a
                        href="{{ route('teacher.borrowed-books') }}"
                        class="flex items-center gap-3 w-full rounded-[14px] border border-[#f3cbe0] px-4 py-3 text-left text-sm text-[#4b2036] hover:bg-[#fff2f8] transition"
                    >
                    ...
                    <a
                        href="{{ route('teacher.reserved-books') }}"
                        class="flex items-center gap-3 w-full rounded-[14px] border border-[#f3cbe0] px-4 py-3 text-left text-sm text-[#4b2036] hover:bg-[#fff2f8] transition"
                    >
        ...
        {{-- Student Registration Chart (from manage students) --}}
        <section class="rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('teacher.manage-students') }}" class="rounded-full border border-[#f3cbe0] px-4 py-2 text-sm text-[#a03464] hover:bg-[#fff2f8] transition">
                    Manage
                </a>
            </div>
            <div class="h-64">
        ...
        @if($recentlyAddedBooks->count() > 0)
            <section class="rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('teacher.books') }}" class="text-sm font-semibold text-[#a03464] hover:underline">View all</a>
                </div>
                <div class="grid gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                    @foreach ($recentlyAddedBooks as $book)
                        <article class="group relative flex flex-col gap-2 items-center text-center">
                            <a
                                href="{{ route('teacher.books') }}?book={{ $book->id }}"
                            ...
                            <div class="w-full max-w-[180px]">
                                <h3 class="font-semibold text-[#4b2036] text-sm line-clamp-2 min-h-[2.5rem]">
                                    <a href="{{ route('teacher.books') }}?book={{ $book->id }}" class="hover:text-[#a03464] transition">
        ...
        @if($recentBorrows->count() > 0)
            <section class="rounded-[24px] border border-[#f3cbe0] bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('teacher.borrowed-books') }}" class="text-sm font-semibold text-[#a03464] hover:underline">View all</a>
                </div>
                <div class="space-y-3">
