...
@section('content')
    ...
    >
        <div
            ...
            x-transition
            class="rounded-2xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800 mb-6"
            x-text="statusMessage"
        ></div>

        @if (session('status'))
            <div class="rounded-2xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800 mb-6">
                {{ session('status') }}
            </div>
        @endif
        ...
        <div class="rounded-[24px] border border-[#f3cbe0] bg-white">
            <div class="flex flex-wrap items-center gap-3 border-b border-[#f3cbe0] px-6 py-4">
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('teacher.manage-students') }}" class="ml-auto relative" x-data="{ searchQuery: '{{ request('search', '') }}' }">
                            <input
                                type="search"
                                name="search"
                                x-model="searchQuery"
            ...
            <div id="student-meta" x-ref="studentMeta" class="border-t border-[#f3cbe0] px-6 py-4">
                @php
            ...
            >
                ...
                >
                    <div class="flex items-center justify-between px-4 py-4 sm:px-6 sm:py-4">
                        <div>
                            <h2 class="text-xl sm:text-2xl font-semibold text-[#4b2036] leading-tight">Add Student</h2>
                        </div>
                        <button
                            type="button"
        ...
        <template x-teleport="body">
            ...
            >
                ...
                >
                    <div class="flex items-center justify-between px-4 py-4 sm:px-6 sm:py-4">
                        <div>
                            <h2 class="text-xl sm:text-2xl font-semibold text-[#4b2036] leading-tight">Edit Student</h2>
                        </div>
                        <button
                            type="button"
                            class="rounded-full border border-[#f3cbe0] p-2 text-[#a03464] hover:bg-[#fff2f8]"
                    ...
                    <div class="px-4 pb-4 sm:px-6 sm:pb-6" x-show="editingStudent">
                        <form
                            method="POST"
                    ...
                    <div x-show="!editingStudent" class="px-4 pb-4 sm:px-6 sm:pb-6">
