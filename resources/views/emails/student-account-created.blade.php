                ...
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #7c4c63; font-size: 16px; line-height: 1.6;">
                                Your student account has been successfully created in the OnShelf GTDL Library Management System. You can now access the library and borrow books!
                            </p>
                            ...
                            <div style="background-color: #fff7fb; border-left: 4px solid #a03464; padding: 20px; margin: 20px 0; border-radius: 8px;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #7c4c63; font-size: 14px;"><strong>LRN:</strong></td>
                                        <td style="padding: 8px 0; color: #4b2036; font-size: 14px; font-weight: bold;">{{ $lrn }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <p style="margin: 20px 0 0 0; color: #7c4c63; font-size: 14px; line-height: 1.6;">
                                If you have any questions or need assistance, please contact your teacher or the library administrator.
                            </p>
