                ...
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <h2 style="margin: 0 0 20px 0; color: #4b2036; font-size: 22px;">Book Returned Successfully!</h2>
                            ...
                            <p style="margin: 0 0 20px 0; color: #7c4c63; font-size: 16px; line-height: 1.6;">
                                We're pleased to confirm that your borrowed book has been successfully returned:
                            </p>
                            ...
                            <div style="background-color: #f0fdf4; border-left: 4px solid #10b981; padding: 20px; margin: 20px 0; border-radius: 8px;">
                                ...
                                <p style="margin: 5px 0; color: #7c4c63; font-size: 14px;"><strong>Returned Date:</strong> <span style="color: #10b981; font-weight: bold;">{{ $returnDate }}</span></p>
                            </div>
                            
                            <p style="margin: 20px 0 0 0; color: #7c4c63; font-size: 16px; line-height: 1.6;">
                                Thank you for returning the book on time! We appreciate your responsible use of the library.
                            </p>
                            
                            <p style="margin: 20px 0 0 0; color: #7c4c63; font-size: 14px; line-height: 1.6;">
                                We hope you enjoyed reading it. Feel free to borrow more books from our library!
                            </p>
                        </td>
                    </tr>
