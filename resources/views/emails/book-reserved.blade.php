                ...
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <h2 style="margin: 0 0 20px 0; color: #4b2036; font-size: 22px;">Book Reserved Successfully!</h2>
                            ...
                            <p style="margin: 0 0 20px 0; color: #7c4c63; font-size: 16px; line-height: 1.6;">
                                We're pleased to confirm that you have successfully reserved the following book:
                            </p>
                            ...
                            <div style="background-color: #fff7fb; border-left: 4px solid #f9c74f; padding: 20px; margin: 20px 0; border-radius: 8px;">
                                <h3 style="margin: 0 0 10px 0; color: #4b2036; font-size: 18px;">{{ $bookName }}</h3>
                                <p style="margin: 5px 0; color: #7c4c63; font-size: 14px;"><strong>Reserve Date:</strong> {{ $reserveDate }}</p>
                                <p style="margin: 5px 0; color: #7c4c63; font-size: 14px;"><strong>Due Date:</strong> {{ $dueDate }}</p>
                                <p style="margin: 5px 0; color: #7c4c63; font-size: 14px;"><strong>Claim Deadline:</strong> <span style="color: #f9c74f; font-weight: bold;">{{ $claimDeadline }}</span></p>
                            </div>
                            
                            <div style="background-color: #fef3c7; border: 1px solid #f9c74f; padding: 15px; margin: 20px 0; border-radius: 8px;">
                                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                                    <strong>Important:</strong> Please claim your reserved book before <strong>{{ $claimDeadline }}</strong>. Reservations not claimed by the deadline will be automatically voided.
                                </p>
                            </div>
