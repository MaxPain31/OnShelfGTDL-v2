...
>
    ...
    @php
        $links = [
            ['label' => 'My Shelf', 'route' => 'teacher.my-shelf', 'icon' => 'library'],
            ['label' => 'Books', 'route' => 'teacher.books', 'icon' => 'book-open'],
            ['label' => 'E-Books', 'route' => 'teacher.ebooks', 'icon' => 'tablet'],
            ['label' => 'Borrowed Books', 'route' => 'teacher.borrowed-books', 'icon' => 'book-copy'],
            ['label' => 'Reserve Books', 'route' => 'teacher.reserved-books', 'icon' => 'bookmark'],
            ['label' => 'Rules & Regulation', 'route' => 'teacher.rules', 'icon' => 'shield-check'],
        ];

        $isManageStudentsActive = request()->routeIs('teacher.manage-students');
    ...
    <nav class="flex-1 space-y-2">
        ...
        {{-- Manage Student Link --}}
        <a
            href="{{ route('teacher.manage-students') }}"
            class="flex items-center gap-3 rounded-[14px] px-3 py-3 transition"
            :class="[
                '{{ $isManageStudentsActive ? 'bg-white text-[#a03464]' : 'text-white/90 hover:bg-white/10' }}',
                $store.sidebar.collapsed ? 'justify-center' : ''
            ]"
        >
            <i data-lucide="graduation-cap" class="w-5 h-5"></i>
            <span class="text-sm font-medium" x-show="!$store.sidebar.collapsed" x-cloak>Manage Student</span>
        </a>
